  ...
  module Listeners
    class PiiVisitListener
      def project_cancelled(project)
        Action.create(project:, klass: 'Ops::Listeners::PiiVisitListener', action: 'project_cancelled')
        Ops::Operations::Projects::PiiVisits::CancelActive.call(project)
      end

      def project_pending_project_visit(project)
        Action.create(project:, klass: 'Ops::Listeners::PiiVisitListener', action: 'project_pending_project_visit')
