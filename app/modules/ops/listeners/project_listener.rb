class Ops::Listeners::ProjectListener
  ...
  def project_pending_collection(project)
    Action.create(klass: 'Ops::Listeners::ProjectListener', action: 'project_pending_collection')
    Ops::Operations::Projects::UpdateDependentQcProject.call(project)
  end

  def project_funds_requested(project)
    Action.create(klass: 'Ops::Listeners::ProjectListener', action: 'project_funds_requested')
    Ops::Operations::Projects::UpdateDependentQcProject.call(project)
  end

  def project_paid_and_complete(project)
    Action.create(klass: 'Ops::Listeners::ProjectListener', action: 'project_paid_and_complete')
    Ops::Operations::Projects::UpdateDependentQcProject.call(project)
  end
end
